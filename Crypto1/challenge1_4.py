...
def get_english_score(input_bytes):
    ...
    return sum
def main():
    encoded_strings_file = open('/home/noob/Documents/Crypto1/4.txt','r')
    list_of_text = encoded_strings_file.readlines()
    list_of_decoded = []
    for encoded_string in list_of_text:
        ...
        #print(sorted_dict[0])
        list_of_decoded.append(sorted_dict[0])
    sorted_decoded = sorted(list_of_decoded,key = lambda x:x['score'],reverse=True)
    print(sorted_decoded[0])
    encoded_strings_file.close()
